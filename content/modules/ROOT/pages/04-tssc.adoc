...
[source,sh,subs="attributes",role=execute]
----
cosign verify --key ~/cosign.pub registry-quay-quay-operator.{subdomain}.opentlc.com/workshop{usernum}/globex-ui:main-b183894cabd3eebaa5844143d5ac60dc9863fb57
----
...
[{"critical":{"identity":{"docker-reference":"registry-quay-quay-operator.{subdomain}/workshop{usernum}/globex-ui"},"image":{"docker-manifest-digest":"sha256:0f1af3459f8eed8c0db38d68b1e0b2f34e938276797f4e5c27fc9f97ad242e32"},"type":"cosign container image signature"},"optional":null}]
----
...
In this workshop RHTAS has been deployed and Tekton Chains has been configured to automatically upload the metadata needed to verify the signature in the transparency log.
...
[source,sh,subs="attributes",role=execute]
----
export SIGSTORE_REKOR_URL=https://rekor-server-trusted-artifact-signer.{subdomain}
export REKOR_REKOR_SERVER=https://rekor-server-trusted-artifact-signer.{subdomain}
...
Next perform the verification by executing the following command:

[.console-input]
[source,sh,subs="attributes",role=execute]
----
cosign verify --key ~/cosign.pub --rekor-url=https://rekor-server-trusted-artifact-signer.{subdomain} registry-quay-quay-operator.{subdomain}/workshop{usernum}/globex-ui:main-b183894cabd3eebaa5844143d5ac60dc9863fb57
----
