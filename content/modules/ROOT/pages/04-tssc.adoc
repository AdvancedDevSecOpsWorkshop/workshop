...
[source,yaml,subs="+macros,attributes+"]
----
include::ROOT:example$globeex-ui/templates/secret-cosign.yaml[]
----
...
Next verify that you retrieved the certificate viewing the file:
...
Finally use the `cosign` command to verify the image:

[.console-input]
[source,sh,subs="attributes",role=execute]
----
cosign verify --key ~/cosign.pub registry-quay-quay-operator.apps.cluster-f7qxj.f7qxj.sandbox1749.opentlc.com/workshop1/globex-ui:main-b183894cabd3eebaa5844143d5ac60dc9863fb57
----
...
[{"critical":{"identity":{"docker-reference":"registry-quay-quay-operator.apps.cluster-f7qxj.f7qxj.sandbox1749.opentlc.com/workshop1/globex-ui"},"image":{"docker-manifest-digest":"sha256:0f1af3459f8eed8c0db38d68b1e0b2f34e938276797f4e5c27fc9f97ad242e32"},"type":"cosign container image signature"},"optional":null}]
----
