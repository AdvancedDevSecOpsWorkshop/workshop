...
This verification is performed every time the image is built, however in the next section we will look at how we can enforce a signature requirement through a runtime policy.
