...
[source,sh,subs="attributes",role=execute]
----
cat ~/workshop/content/modules/ROOT/examples/web-nodejs-dev.yaml | sed 's/$USER/{user}/' ~/web-nodejs-dev.yaml | oc create -f - -n {user}-argocd
----
...
[source,sh,subs="attributes",role=execute]
----
cat ~/workshop/content/modules/ROOT/examples/web-nodejs-prod.yaml | sed 's/$USER/{user}/' ~/web-nodejs-dev.yaml | oc create -f - -n {user}-argocd
----
