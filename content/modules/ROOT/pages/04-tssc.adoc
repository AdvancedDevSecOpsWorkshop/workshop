...
[source,sh,subs="attributes",role=execute]
----
cd && wget https://gitea-gitea.{openshift_cluster_ingress_domain}/{user}/workshop/raw/branch/main/content/modules/ROOT/examples/web-nodejs-dev.yaml && 
...
[source,sh,subs="attributes",role=execute]
----
cd && wget https://gitea-gitea.{openshift_cluster_ingress_domain}/{user}/workshop/raw/branch/main/content/modules/ROOT/examples/web-nodejs-prod.yaml && 
