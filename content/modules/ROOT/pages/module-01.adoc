...
This module will give you a comprehensive understanding of OpenShift as an Application Platform that can accelerate their day-to-day activities, from modernization to build, deploy, manage, and auto-scale your applications with serverless in a hybrid cloud and at the edge.
...
Fig 1. The image shows an Overview of the OpenShift as an Application Platform.
